...
public class ColdairProcessNCity {
    ...
    private Integer totalStationCountMax;
    ...
    public Integer getTotalStationCountMax() {
        return totalStationCountMax;
    }

    public void setTotalStationCountMax(Integer totalStationCountMax) {
        this.totalStationCountMax = totalStationCountMax;
    }
